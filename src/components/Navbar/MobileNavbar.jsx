...
const MobileNavbar = () => {
    ...
    return (
        <div className={`fixed bottom-0 mx-auto w-[100%] h-15 border-r border-gray-600 scroll-smooth transition-all duration-300`} id={dark == true ? "dark" : ""}>
            <ul className='flex justify-center'>
                ...
                <li onClick={homeHendler} className={`p-1  rounded-lg hSideNav ${navActive === "home" ? "active" : ""}`} style={{ cursor: "pointer" }}>
                    <HomeIcon className='' />
